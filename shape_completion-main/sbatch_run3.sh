...
xvfb-run -a -s "-screen 0 1440x900x24" python src/core/main.py --exp_name LSTM_centralize_lambda --run_windowed_lstm_decoder --window_size 8 --stride 16 --centralize_com --version 33 --batch_size 8 
