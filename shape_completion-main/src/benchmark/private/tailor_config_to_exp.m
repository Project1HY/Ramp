...
switch c.curr_tgt_ds
    case {'faust'}
        c.path.full_shape_dir = fullfile(c.path.data_dir,'Faust','full');
        c.path.projection_dir = fullfile(c.path.data_dir,'Faust','azimuthal_projections');
    case {'amass'}
    ...
    case {'smal'}
        c.path.full_shape_dir = fullfile(c.path.data_dir,'SMALTestPyProj','full');
        c.path.projection_dir = fullfile(c.path.data_dir,'SMALTestPyProj','projections');
    case {'dfaust'}
        error('Unimplemented');
    otherwise
