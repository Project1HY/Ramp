...
class NeptuneLogger(LightningLoggerBase):
    ...
    def __init__(self, api_key=None, project_name=None, offline_mode=False,
        ...
        .. code-block:: python
            ...
            # arguments made to NeptuneLogger are passed on to the neptune.exp.Experiment class
        ...
        Args:
            ...
            experiment_name (str|None): Optional. Editable name of the experiment.
               Name is displayed in the experiment’s Details (Metadata section) and in exp view as a column.
            ...
            params (dict|None): Optional. Parameters of the experiment. After experiment creation params are read-only.
               ...
               viewed in exp view as a column.
            properties (dict|None): Optional default is {}. Properties of the experiment.
               ...
               each key-value pair can be viewed in exp view as a column.
            tags (list|None): Optional default []. Must be list of str. Tags of the experiment.
               ...
               Tags are displayed in the experiment’s Details and can be viewed in exp view as a column.
        """
        super().__init__()
    ...
    def log_metrics(self, metrics, step=None):
        """Log metrics (numeric values) in Neptune exp
