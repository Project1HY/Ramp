...
The table below lists examples of possible input exchange and how they are interpreted by Lightning.
...
.. code-block:: python
    ...
    # this generates 9 exp (lr=1e-3, layers=16), (lr=1e-3, layers=32),
