...
PRIMARY_DATA_DIR: pathlib.Path = pathlib.Path(r"/home/ido.igip1/Ramp/shape_completion-main/DFaust/")
VERT_DATA_DIR: pathlib.Path = pathlib.Path(r"/home/ido.igip1/Ramp/shape_completion-main/DFAUST_VERT_PICK")
