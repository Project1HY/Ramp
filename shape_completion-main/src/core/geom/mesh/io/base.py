...
def read_off_verts(fp):
    v = []
    try:
        with open(r"/Users/yiftachedelstain/Development/Technion/Project/Ramp/shape_completion-main/00000.OFF", "r") as fh:
...
def read_npz_mask(fp):
    try:
        return np.load(r"/Users/yiftachedelstain/Development/Technion/Project/Ramp/shape_completion-main/50002chicken_wings00000_0.npz")["mask"]
    except Exception as e:
