...
def parser():
    ...
    # Check-pointing
    p.add_argument('--exp_name', type=str, default='Siamese_Random_Decimation',
...
def train_main():
    ...
    # Bring in data:
    # TODO - need to check decimation works well
    ldrs = f2p_completion_random_decimation_loaders(nn.hp)
