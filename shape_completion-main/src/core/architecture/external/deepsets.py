...
# TODO - used by Point Cloud GAN. Shows competetive performance to PointNet with half the parameters.
# TODO - Deepset better with Joints, PointNet better with segmentations
